...
//$sql = "SELECT remesas_env_chile_bolivia.CODIGO, report_chile_bolivia.CODIGO_R, remesas_env_chile_bolivia.FECHA, report_chile_bolivia.FECHA_ORI,report_chile_bolivia.FECHA_PAG,remesas_env_chile_bolivia.ESTADO, report_chile_bolivia.ESTADO_R FROM remesas_env_chile_bolivia INNER JOIN report_chile_bolivia ON remesas_env_chile_bolivia.AIR = report_chile_bolivia.AIR_R WHERE remesas_env_chile_bolivia.ESTADO = report_chile_bolivia.ESTADO_R AND report_chile_bolivia.FECHA_PAG = '0000-00-00 00:00:00';";
...
<div class="text-right">
    ...
    <a href="ReportePDF/PDFconsulta3.php?from_date=<?php echo $_GET['from_date']; ?>&to_date=<?php echo $_GET['to_date']; ?>" target="_blank" class ="btn btn-success">
                ...
                <tbody>
                    <?php 
                        if(isset($_GET['from_date']) && isset($_GET['to_date'])){
                            ...
                            $query ="SELECT remesas_env_chile_bolivia.CODIGO, report_chile_bolivia.CODIGO_R, remesas_env_chile_bolivia.FECHA, report_chile_bolivia.FECHA_ORI,report_chile_bolivia.FECHA_PAG,remesas_env_chile_bolivia.ESTADO, report_chile_bolivia.ESTADO_R FROM remesas_env_chile_bolivia INNER JOIN report_chile_bolivia ON remesas_env_chile_bolivia.AIR = report_chile_bolivia.AIR_R WHERE remesas_env_chile_bolivia.ESTADO = report_chile_bolivia.ESTADO_R AND report_chile_bolivia.FECHA_PAG = '0000-00-00 00:00:00'  AND DATE(FECHA) BETWEEN '$from_date' AND '$to_date';";
