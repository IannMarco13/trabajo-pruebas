...
$query = ("SELECT remesas_env_chile_bolivia.CODIGO,remesas_env_chile_bolivia.REMITENTE, remesas_env_chile_bolivia.FECHA, report_chile_bolivia.FECHA_PAG,remesas_env_chile_bolivia.ESTADO, report_chile_bolivia.ESTADO_R FROM remesas_env_chile_bolivia INNER JOIN report_chile_bolivia ON remesas_env_chile_bolivia.AIR = report_chile_bolivia.AIR_R
WHERE remesas_env_chile_bolivia.ESTADO ='PAGADO' AND DATE(FECHA) BETWEEN '$from_date' AND '$to_date'");
...
WHERE remesas_env_chile_bolivia.ESTADO = report_chile_bolivia.ESTADO_R AND remesas_env_chile_bolivia.ESTADO = 'PAGADO' AND DATE(FECHA) BETWEEN '$from_date' AND '$to_date'";
...
$pdf->Output('Consulta2.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
?>
