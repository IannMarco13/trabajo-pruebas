...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE REMESAS NO PAGADAS"), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(40, 10, utf8_decode('MONTO BOB'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('USD'), 1, 0, 'C', 1);
...
$query = ("SELECT remesas_env_chile_bolivia.CODIGO,remesas_env_chile_bolivia.REMITENTE, remesas_env_chile_bolivia.FECHA, report_chile_bolivia.MONTO_BOB,report_chile_bolivia.MONTO_USD, report_chile_bolivia.ESTADO_R FROM remesas_env_chile_bolivia INNER JOIN report_chile_bolivia ON remesas_env_chile_bolivia.AIR = report_chile_bolivia.AIR_R WHERE remesas_env_chile_bolivia.ESTADO = report_chile_bolivia.ESTADO_R AND report_chile_bolivia.FECHA_PAG = '0000-00-00 00:00:00' AND DATE(FECHA) BETWEEN '$from_date' AND '$to_date'");
...
if(mysqli_num_rows($query_run) > 0){
   foreach($query_run as $fila){     
    ...
    $pdf->Cell(40, 10, utf8_decode($fila['MONTO_BOB']), 1, 0, 'C', 0);
    $pdf->Cell(40, 10, utf8_decode($fila['MONTO_USD']), 1, 0, 'C', 0);
...
$pdf->AliasNbPages(); 
$query_T = "SELECT SUM(report_chile_bolivia.MONTO_BOB) AS sum_bob , SUM(report_chile_bolivia.MONTO_USD) AS sum_usd
FROM remesas_env_chile_bolivia
INNER JOIN report_chile_bolivia ON remesas_env_chile_bolivia.AIR = report_chile_bolivia.AIR_R
WHERE remesas_env_chile_bolivia.ESTADO = report_chile_bolivia.ESTADO_R
AND report_chile_bolivia.FECHA_PAG = '0000-00-00 00:00:00'
AND DATE(FECHA) BETWEEN '$from_date' AND '$to_date'";
...
$pdf->Output('Consulta3.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
?>
